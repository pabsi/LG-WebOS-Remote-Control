...
<!-- ################################# SOURCE BUTTONS ################################# -->
                  ...
                  <div class="grid-container-source">
                      ...
                      <button class="btn_source ripple" @click=${() => this._select_source("Amazon Prime Video")}>${LgRemoteControl.amznIcon}</button>
